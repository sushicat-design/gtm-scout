...
.ring3{width:200px;height:200px;background:radial-gradient(circle,rgba(45,157,232,0.07) 0%,transparent 70%);border:none;animation-delay:2s}
@keyframes rp{0%,100%{transform:scale(1);opacity:1}50%{transform:scale(1.05);opacity:.6}}
.pip{width:200px;height:200px;object-fit:contain;animation:pf 5s ease-in-out infinite;filter:drop-shadow(0 0 40px rgba(45,157,232,0.5));position:relative;z-index:1}
...
.cpip{width:100px;height:100px;object-fit:contain;margin:0 auto 24px;display:block;filter:drop-shadow(0 0 32px rgba(45,157,232,0.5));animation:pf 5s ease-in-out infinite}
...
<section class="hero">
  <div>
    ...
    <div class="stats">
      <div class="stat"><div class="stn">8<span>s</span></div><div class="stl">Per research</div></div>
  ...
  <div class="hr">
    <div class="pc">
      ...
      <div class="badge b1">GTM Score <strong style="color:var(--pip2);font-family:'JetBrains Mono',monospace">87</strong></div>
      <div class="badge b2">Hot Lead <strong style="color:#10b981;font-family:'JetBrains Mono',monospace">confirmed</strong></div>
      <img class="pip" src="data:image/png;base64," alt="Pip">
      <div class="pipl">Pip &mdash; your research assistant</div>
    </div>
  </div>
</section>
<div class="mq">
...
<section class="sec" id="features">
  ...
  <h2>Everything you need to land the right client</h2>
  <p class="ssub">From cold company name to personalised pitch in under 10 seconds.</p>
  <div class="fg">
    <div class="fc"><div class="fn">01</div><div class="ft">GTM Score</div><p class="fd">AI-generated readiness score from 0-100. Know instantly if a company needs what you offer.</p></div>
    <div class="fc"><div class="fn">02</div><div class="ft">Pitch Opener</div><p class="fd">Personalised first-line cold outreach built from real signals. Not a template. Never generic.</p></div>
    <div class="fc"><div class="fn">03</div><div class="ft">Lead Fetch</div><p class="fd">Pull recently funded companies from the web. Review in Inbox, approve to pipeline.</p></div>
    <div class="fc"><div class="fn">04</div><div class="ft">Pipeline</div><p class="fd">Kanban from Not Contacted to Closed. Every company you research lives here.</p></div>
    <div class="fc"><div class="fn">05</div><div class="ft">Pip Hunt</div><p class="fd">Find CMO and marketing leadership roles at companies actively hiring. Built into Scout.</p></div>
    <div class="fc"><div class="fn">06</div><div class="ft">Your Profile</div><p class="fd">Positioning, services, and case studies in one place. Share with prospects.</p></div>
  </div>
</section>
...
<div class="ctaw">
  <div class="ctac">
    ...
    <div class="ch2">Ready to find<br>your next client?</div>
    <p class="cs">Join Scout free. Your first 5 researches are on us.</p>
